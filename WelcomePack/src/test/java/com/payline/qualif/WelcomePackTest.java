...
public class WelcomePackTest{
	...
	@Test
	public void method1(){
		WsdlTestCase tc = willBeExecuted.get(1);
		TestRunner runner = tc.run(new PropertiesMap(), false);
		Assert.assertEquals(Status.FINISHED, runner.getStatus());
	}
	...
	@Test
	public void method2(){
		WsdlTestCase tc = willBeExecuted.get(2);
		TestRunner runner = tc.run(new PropertiesMap(), false);
		Assert.assertEquals(Status.FINISHED, runner.getStatus());
	}
	...
	@Test
	public void method3(){
		WsdlTestCase tc = willBeExecuted.get(3);
		TestRunner runner = tc.run(new PropertiesMap(), false);
		Assert.assertEquals(Status.FINISHED, runner.getStatus());
	}
	...
	@Test
	public void method4(){
		WsdlTestCase tc = willBeExecuted.get(4);
		TestRunner runner = tc.run(new PropertiesMap(), false);
		Assert.assertEquals(Status.FINISHED, runner.getStatus());
	}
	...
	@Test
	public void method5(){
		WsdlTestCase tc = willBeExecuted.get(5);
		TestRunner runner = tc.run(new PropertiesMap(), false);
		Assert.assertEquals(Status.FINISHED, runner.getStatus());
	}
